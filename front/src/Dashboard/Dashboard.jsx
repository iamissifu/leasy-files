    ...
    <div className="px-4">
      <div className="w-full mx-auto">
        <div className="bg-white rounded-3xl p-8 mb-5">
          <h1 className="text-3xl font-bold mb-10">LizyEasy Admin Dashboard </h1>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-2">
                  <div className="p-4 bg-green-100 rounded-xl">
                    <div className="font-bold text-xl text-gray-800 leading-none">Number of downloads <br/> </div>
                    <div className="mt-5">
                ...
                <div className="col-span-2">
                  <div className="p-4 bg-purple-100 rounded-xl text-gray-800">
                    <div className="font-bold text-xl leading-none">Number of email sent</div>
                    <div className="mt-2 justify-center py-2 px-3 rounded-xl bg-white text-gray-80 hover:text-green-500 text-sm font-semibold transition">5 </div>
                  </div>
                </div>
              </div>
            </div>
